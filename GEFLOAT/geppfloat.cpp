...
float absval(float);
void INPUT(int *, float [][30], int *);
void OUTPUT(int, int, int, int *, float *, float [][30]);
...
void INPUT(int *OK, float A[][30], int *N)
{
   int I, J;
   char AA;
   char NAME[30];
...
void OUTPUT(int N, int M, int ICHG, int *NROW, float *X, float A[][30])
{
   int I, J, FLAG;
   char NAME[30];
   FILE *OUP;
