...
*
*                       using arithmetic with type double
*
...
void INPUT(int *, double [][30], int *);
void OUTPUT(int, int, int, double *, double [][30]);
...
void INPUT(int *OK, double A[][30], int *N)
{
   int I, J;
   char AA;
   char NAME[30];
...
void OUTPUT(int N, int M, int ICHG, double *X, double A[][30])
{
   int I, J, FLAG;
   char NAME[30];
   FILE *OUP;
